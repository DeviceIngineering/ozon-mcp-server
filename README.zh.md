...
财务——基于 Ozon Seller API 与 Performance API 的 156 个工具（Ozon 是俄罗斯最大的
...
这是作者自用的生产工具：已经每天使用五个多月，管理约二十个卖家账号，156 个工具。
...
**工具定义。** 单店铺配置下，156 个工具占 **12 300 tokens**，此前为 18 386：描述压缩成
...
- **`ozon_mcp/server.py`**——MCP 服务器本体。`TOOLS` 列表描述全部 156 个工具（名称、
