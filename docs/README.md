...
## Если что-то сломалось на стороне Ozon

Как часто выходят обновления и куда писать, если исправление нужно срочно, —
[«Обновления и поддержка»](../README.md#обновления-и-поддержка) в основном README.
